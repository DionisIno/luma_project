...
class TestFooter:
    ...
    @pytest.mark.parametrize('URL', DATA_1)
    def test_tc_02_01_30_clickability_of_write_for_us_link_on_pages(self, driver, URL):
    ...
    @pytest.mark.parametrize('URL', DATA_1)
    def test_tc_02_01_32_text_of_write_for_us_link_on_pages(self, driver, URL):
