...
class FooterPageLocators:
    ...
    CONTACT_US_LINK = (By.CSS_SELECTOR, '.footer div :nth-child(4) a')                      # updated 01.20.2024
    ...
    SEARCH_TERMS_LINK = (By.CSS_SELECTOR, ".footer > :nth-child(2) > a")                    # updated 01.20.2024
    SUBSCRIBE_TO_OUR_MAILING_LIST_LINK = (By.CSS_SELECTOR, '.footer div :nth-child(3) a')   # updated 01.20.2024
    WRITE_FOR_US_LINK = (By.CSS_SELECTOR, '.footer div ul :nth-child(2) a')                 # updated 01.20.2024
